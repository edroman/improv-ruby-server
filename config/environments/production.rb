  ...
  # Configure automatic compilation of assets in production (Heroku will then handle this for us)
  ...
  # For ActiveAdmin
  config.action_mailer.default_url_options = { :host => 'atalltale.com' }
